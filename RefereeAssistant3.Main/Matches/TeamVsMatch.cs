...
namespace RefereeAssistant3.Main.Matches
{
    public class TeamVsMatch
    {
        ...
        private readonly List<TeamVsMatchSnapshot> history = new List<TeamVsMatchSnapshot>();
        public IReadOnlyList<TeamVsMatchSnapshot> History => history;
        private readonly List<TeamVsMatchSnapshot> cancelledOperations = new List<TeamVsMatchSnapshot>();
        public IReadOnlyList<TeamVsMatchSnapshot> CancelledOperations => cancelledOperations;

        public event Action Updated;
        public event Action<TeamVsMatch, string> Alert;
        ...
        public TeamVsMatch(Team team1, Team team2, Tournament tournament, TournamentStage tournamentStage)
        {
            ...
            history.Add(new TeamVsMatchSnapshot(this, ReadableCurrentState));

            RefreshTimeOut();
        }

        public TeamVsMatch(Core core, APIMatch apiMatch)
        {
